...
+ (id)sharedImageCache;
@property(retain, nonatomic) dispatch_queue_t ioQueue; // @synthesize ioQueue=_ioQueue;
...
- (void)calculateSizeWithCompletionBlock:(id/*CDUnknownBlockType*/)arg1;
- (unsigned long long)getDiskCount;
- (unsigned long long)getSize;
- (void)backgroundCleanDisk;
- (void)cleanDiskWithCompletionBlock:(id/*CDUnknownBlockType*/)arg1;
- (void)cleanDisk;
- (void)clearDiskOnCompletion:(id/*CDUnknownBlockType*/)arg1;
- (void)clearDisk;
- (void)clearMemory;
@property(nonatomic) unsigned long long maxMemoryCountLimit;
@property(nonatomic) unsigned long long maxMemoryCost;
- (void)removeImageForKey:(id)arg1 fromDisk:(_Bool)arg2 withCompletion:(id/*CDUnknownBlockType*/)arg3;
...
- (id)queryDiskCacheForKey:(id)arg1 done:(id/*CDUnknownBlockType*/)arg2;
...
- (void)diskImageExistsWithKey:(id)arg1 completion:(id/*CDUnknownBlockType*/)arg2;
